...
const QuotationMasterReportPage = createSidebarPlaceholderPage(
  "Quotation Report",
  "Quotation analytics and summary reports.",
);
...
const QueryMasterReportPage = createSidebarPlaceholderPage(
  "Query Report",
  "Query pipeline reports and tracking summaries.",
);
