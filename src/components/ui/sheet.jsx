...
/**
 * Side drawer built on Radix Dialog. Drop-in replacement for CoreUI's
 * COffcanvas — `open`/`onOpenChange` drive visibility, `side` picks the
 * edge. Keeps focus trap, escape-to-close, and scroll lock for free.
 */
...
const sheetVariants = cva(
  "fixed z-[1050] flex flex-col bg-card shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
