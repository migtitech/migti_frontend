...
/**
 * My Performance — a clean, standalone report of the logged-in person's own
 * procurement work only (no cross-section sub-nav / tabs). Shows rate targets
 * vs submitted, on-time %, turnaround, stage breakdown and recent activity.
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Your own procurement work — rate targets vs what you submitted, on-time %, turnaround and recent activity. Sample data for UI preview."
      />
