            ...
            <CCardBody>
              <CListGroup flush>
                ...
                <CListGroupItem>
                  ...
                  <p className="mb-0 mt-2">{supplier.shippingAddress || 'No shipping address provided'}</p>
                </CListGroupItem>
                <CListGroupItem>
                  <strong>Billing Address:</strong>
                  <p className="mb-0 mt-2">{supplier.billingAddress || 'No billing address provided'}</p>
                </CListGroupItem>
                <CListGroupItem>
