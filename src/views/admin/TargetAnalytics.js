              ...
              <>
                <CNav variant="tabs" className="mb-3">
                  {!isSalesRole && (
                    <CNavItem>
                      <CNavLink
                        active={viewTab === VIEW_TAB.branch}
                        onClick={() => setViewTab(VIEW_TAB.branch)}
                      >
                        Branch
                      </CNavLink>
                    </CNavItem>
                  ...
                  <CNavItem>
                    <CNavLink
                      active={viewTab === VIEW_TAB.zone}
                      onClick={() => setViewTab(VIEW_TAB.zone)}
                    >
                      Zone
                    </CNavLink>
                  </CNavItem>
                  <CNavItem>
                    <CNavLink
                      active={viewTab === VIEW_TAB.employee}
                      onClick={() => setViewTab(VIEW_TAB.employee)}
                    >
                      Employee
                    </CNavLink>
                  </CNavItem>
                ...
                <CNav variant="tabs" className="mb-3">
                  <CNavItem>
                    <CNavLink
                      active={tableTab === TABLE_TAB.active}
                      onClick={() => setTableTab(TABLE_TAB.active)}
                    >
                      Active Targets
                    </CNavLink>
                  </CNavItem>
                  <CNavItem>
                    <CNavLink
                      active={tableTab === TABLE_TAB.history}
                      onClick={() => setTableTab(TABLE_TAB.history)}
                    >
                      History Targets
                    </CNavLink>
                  </CNavItem>
