                    ...
                    {productInfo && (
                      <div className="mb-3 p-3 bg-light rounded">
                        ...
                        <div className="text-muted small">
                          {productInfo.sku && (
                            <span className="me-3">SKU: {productInfo.sku}</span>
                          )}
                          {productInfo.price > 0 && (
                            <span>
                                ...
                                return (
                                  ...
                                  >
                                    <CFormCheck
                                      ...
                                      name="productCombo"
                                      checked={
                                        selectedProductCombination === uid
                                      }
                                      onChange={() =>
              ...
              <CTabPane visible={activeTab === "addRate"}>
                <CRow className="mb-3">
                  <CCol xs={12}>
                    ...
                    <div className="text-muted small">
                      First choose the product and supplier, then set the rate
                      and next due date.
                    </div>
                  </CCol>
                </CRow>
                    ...
                    <div className="border rounded p-3 h-100">
                      ...
                      {addProductDetail && !loadingProductDetail && (
                        <div className="mt-3 w-100">
                          ...
                          >
                            {addProductDetail?.hasVariants &&
                            addProductDetail?.variantCombinations?.length >
                              0 ? (
                              <div
                                style={{
                                  display: "grid",
                              ...
                              >
                                <CFormCheck
                                  ...
                                  onChange={() =>
                                    setAddSelectedCombination("base")
                                  }
                                />
                  ...
                  <CCol xs={12} md={6}>
                    <div className="border rounded p-3 h-100">
                      ...
                      >
                        ...
                        <div className="text-muted small mt-1">
                          Search by supplier name, shop or phone, then pick one
                      ...
                      <CRow>
                        <CCol xs={12} md={6}>
                          <div className="mb-3">
                            ...
                            />
                            <div className="text-muted small mt-1">
                              Enter the agreed base rate in Indian Rupees for
                              this product and supplier.
                            </div>
                          </div>
                        </CCol>
                        <CCol xs={12} md={6}>
                          <div className="mb-3">
                            ...
                            <CFormInput
                              ...
                              onChange={(e) =>
                                setAddNextDueDate(e.target.value)
                              }
                              min={addNextDueDateMin}
                            />
                            <div className="text-muted small mt-1">
                              Default is 3 months from today. You can move it
                              forward, but past dates are disabled.
                            </div>
                          </div>
                        </CCol>
                      </CRow>
                        ...
                        addNextDueDate && (
                          <div className="mt-2 p-2 bg-light rounded">
                            ...
                            <div className="text-muted small">
                              ...
                              , with next due date{" "}
                              <span className="fw-bold">{addNextDueDate}</span>.
                            </div>
                          </div>
                        )}
                    </div>
