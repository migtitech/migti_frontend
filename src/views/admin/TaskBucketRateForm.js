  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        toastError(err?.response?.data?.message || err?.message || 'Failed to save rate')
      } finally {
        setSubmitting(false)
      }
            ...
            <CForm onSubmit={handleSubmit}>
              <CRow className="g-3">
                <CCol md={6}>
                  ...
                  />
                  {errors.supplierName && (
                    <div className="text-danger small mt-1">{errors.supplierName}</div>
                  )}
                </CCol>
                <CCol md={6}>
                  ...
                  />
                  {errors.contactName && (
                    <div className="text-danger small mt-1">{errors.contactName}</div>
                  )}
                </CCol>
                <CCol md={6}>
                  ...
                  />
                  {errors.contactPhone && (
                    <div className="text-danger small mt-1">{errors.contactPhone}</div>
                  )}
                </CCol>
                <CCol md={4}>
                ...
                <CCol md={8}>
                  ...
                  />
                  {errors.remark && (
                    <div className="text-danger small mt-1">{errors.remark}</div>
                  )}
                </CCol>
