    ...
    <>
            ...
            <>
              ...
              <div className="mb-4 grid grid-cols-1 gap-3 lg:grid-cols-12">
                <Card className="lg:col-span-7">
                  <CardHeader className="py-2">
                    <div>
                      <strong className="text-sm">Amount comparison</strong>
                ...
                <Card className="lg:col-span-5">
                  <CardHeader className="py-2">
                    <div>
                      <strong className="text-sm">Volume split</strong>
                      <span className="ms-2 text-sm text-muted-foreground">
              ...
              {isMobileView ? (
                <div>
                  {rows.length > 0 ? (
                    rows.map((item, index) => {
                      const dateInfo = splitDateTimeParts(item.entryDate, "-");
                      return (
                              ...
                              {item.attachment?.documentId ? (
                                <span className="inline-flex items-center gap-2">
                                  ...
                                  <Button
                                    ...
                                    onClick={() =>
                                      openAttachmentInNewTab(item.attachment)
                                    }
                                  >
                                    View
                                  </Button>
      ...
      >
        <SheetContent side="right" className="w-full p-0 sm:max-w-[420px]">
          <SheetHeader>
            <SheetTitle>Add Sales Order</SheetTitle>
          </SheetHeader>
              ...
              {poAttachment && !poAttachmentUploading && (
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  ...
                  poAttachment.previewUrl ? (
                    ...
                    <span className="text-sm">{poAttachment.fileName}</span>
                  )}
                  <Button
                    type="button"
                    variant="link"
          ...
          <SheetFooter>
            ...
            <Button type="button" onClick={onCreatePo}>
              Save
            </Button>
          </SheetFooter>
        </SheetContent>
      ...
      >
        <SheetContent side="right" className="w-full p-0 sm:max-w-[420px]">
          ...
          <SheetFooter>
            ...
            <Button type="button" variant="success" onClick={onCreateBilling}>
              Save
            </Button>
          </SheetFooter>
        </SheetContent>
